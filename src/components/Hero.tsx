...
const Hero = () => {
  return (
    <section>
        <div className='grid grid-cols-1 sm:grid-cols-12 bg-blue-500'>
        ...
        <div >
            <button className='px-6 py-3 w-full sm:w-fit rounded-full mr-4 
             bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 hover:bg-slate-200'>Hire Me</button>
        ...
        <div className='col-span-5 place-self-center mt-4 lg:mt-0 bg-amber-500'>
